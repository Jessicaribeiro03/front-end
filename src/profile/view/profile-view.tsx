    ...
    render() {
        return (
            <Container>
                ...
                <ImageBox>
                <img
                    src={this.props.user !== undefined ? this.props.user.profileImageUrl : 'https://img.myloview.com.br/adesivos/aprovado-usuario-icone-vector-feminino-pessoa-perfil-avatar-simbolo-em-cor-plana-glifo-pictograma-ilustracao-700-142449291.jpg'}
